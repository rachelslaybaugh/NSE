...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\seta_1$ with $c_1=0.0$}
        \label{fig7a}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\seta_2$ with $c_1=0.0$}
        \label{fig7c}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\seta_3$ with $c_1=0.0$}
        \label{fig7e}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
...
\begin{figure}[p]
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\setb_1$ with $c_1=0.0$}
        \label{fig15a}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\setb_2$ with $c_1=0.0$}
        \label{fig15c}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
    ...
    \begin{subfigure}{0.495\textwidth}
        ...
        \caption{Problem set $\setb_3$ with $c_1=0.0$}
        \label{fig15e}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.495\textwidth}
